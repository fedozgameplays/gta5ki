...
model_name = "model1-0.0001_lr-30_epochs"
mapping_dict = {0: "W",
                1: "S",
                2: "A",
                3: "D",
...
while True:
    ...
    print("Real mobile2-32-batch-0001.hdf5 accuracy: {round(correct/total, 3)}. Accuracy considering 'closeness': {round(closeness/total, 3)}")
    print(dist_dict)
    ...
    with open('log.txt', "a") as f:
        ...
        f.write('\n')
        f.write("Real mobile2-32-batch-0001.hdf5 accuracy: {round(correct/total, 3)}. Accuracy considering 'closeness': {round(closeness/total, 3)}\n")
