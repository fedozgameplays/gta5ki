...
if sys.argv[1] == "record" or sys.argv[0] == "record":
    if len(sys.argv) > 4:
        ...
        main.run(sys.argv[2],sys.argv[3],dateiname)
    else:
    ...
    if len(sys.argv) > 6:
        ...
        model_trainieren.run(sys.argv[2],sys.argv[3],sys.argv[4],sys.argv[5], dateiname)
    else:
        print("Geben sie alle Parameter an.")
    ...
    if len(sys.argv) > 5:
       model_testen.run(sys.argv[2],sys.argv[3],sys.argv[4],sys.argv[5])
    else:
        print("Geben sie alle Parameter an.")
